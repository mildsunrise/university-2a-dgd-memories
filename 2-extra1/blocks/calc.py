...
Implementa un multiplicador BCD amb signe, controlat pel teclat connectat a la placa.
...
exposa com a sortides el mode actual en que es troba ($show$), els factors ($sigA, opA$ i $sigB, opB$)
i el resultat $sigRes, res$.
