...
ports = [
("num7[3..0]", "input", ur"Xifra a mostrar al display~7 (BCD)"),
("num6[3..0]", "input", ur"Xifra a mostrar al display~6 (BCD)"),
("num5[3..0]", "input", ur"Xifra a mostrar al display~5 (BCD)"),
("num4[3..0]", "input", ur"Xifra a mostrar al display~4 (BCD)"),
("num3[3..0]", "input", ur"Xifra a mostrar al display~3 (BCD)"),
("num2[3..0]", "input", ur"Xifra a mostrar al display~2 (BCD)"),
("num1[3..0]", "input", ur"Xifra a mostrar al display~1 (BCD)"),
("num0[3..0]", "input", ur"Xifra a mostrar al display~0 (BCD)"),
