  ...
  \draw[output pin] (18.0000,-10.3810) -- (18.6190,-10.3810) -- (18.7143,-10.4762) -- (18.6190,-10.5714) -- (18.0000,-10.5714) -- cycle;
  \draw[pin name] (18.7143,-10.4762) node[anchor=west] {$\nodenamerange{opA}{3}{0}$};

  % Pin (OUTPUT) named opB[3..0]
  \draw[output pin] (18.0000,-11.5238) -- (18.6190,-11.5238) -- (18.7143,-11.6190) -- (18.6190,-11.7143) -- (18.0000,-11.7143) -- cycle;
  \draw[pin name] (18.7143,-11.6190) node[anchor=west] {$\nodenamerange{opB}{3}{0}$};

  % Pin (OUTPUT) named res[7..0]
  \draw[output pin] (18.0000,-12.6667) -- (18.6190,-12.6667) -- (18.7143,-12.7619) -- (18.6190,-12.8571) -- (18.0000,-12.8571) -- cycle;
  \draw[pin name] (18.7143,-12.7619) node[anchor=west] {$\nodenamerange{res}{7}{0}$};

  % Pin (OUTPUT) named sigA
  \draw[output pin] (18.0000,-10.0000) -- (18.6190,-10.0000) -- (18.7143,-10.0952) -- (18.6190,-10.1905) -- (18.0000,-10.1905) -- cycle;
  \draw[pin name] (18.7143,-10.0952) node[anchor=west] {$\nodenamebit{sigA}$};

  % Pin (OUTPUT) named sigB
  \draw[output pin] (18.0000,-11.1429) -- (18.6190,-11.1429) -- (18.7143,-11.2381) -- (18.6190,-11.3333) -- (18.0000,-11.3333) -- cycle;
  \draw[pin name] (18.7143,-11.2381) node[anchor=west] {$\nodenamebit{sigB}$};

  % Pin (OUTPUT) named sigRes
  \draw[output pin] (18.0000,-12.2857) -- (18.6190,-12.2857) -- (18.7143,-12.3810) -- (18.6190,-12.4762) -- (18.0000,-12.4762) -- cycle;
  \draw[pin name] (18.7143,-12.3810) node[anchor=west] {$\nodenamebit{sigRes}$};
  ...
  \draw[symbol bounds] (14.8571,-10.4762) rectangle (16.3810,-12.3810);
  \draw[symbol type] (15.0952,-10.5952) node[] {DFF};
  ...
  \draw[port name] (15.6310,-12.1429) node[anchor=south] {\textsf{$\nodenamebit{CLRN}$}};
  \draw[port name] (15.2381,-11.0476) node[anchor=west] {\textsf{$\nodenamebit{D}$}};
  \draw[port name] (15.6310,-10.7381) node[anchor=north] {\textsf{$\nodenamebit{PRN}$}};
  \draw[port name] (16.0000,-11.0476) node[anchor=east] {\textsf{$\nodenamebit{Q}$}};

  % Symbol (DFF) named inst11
  \draw[symbol bounds] (14.8571,-13.3333) rectangle (16.3810,-15.2381);
  \draw[symbol type] (15.0952,-13.4524) node[] {DFF};
  ...
  \draw[port name] (15.6310,-15.0000) node[anchor=south] {\textsf{$\nodenamebit{CLRN}$}};
  \draw[port name] (15.2381,-13.9048) node[anchor=west] {\textsf{$\nodenamebit{D}$}};
  \draw[port name] (15.6310,-13.5952) node[anchor=north] {\textsf{$\nodenamebit{PRN}$}};
  \draw[port name] (16.0000,-13.9048) node[anchor=east] {\textsf{$\nodenamebit{Q}$}};

  \draw[node line, ->] (15.6190,-12.9524) -- (15.6190,-12.3810) -- (15.6190,-12.2857);
  \draw[node line, ->] (15.6190,-15.8095) -- (15.6190,-15.2381) -- (15.6190,-15.1429);
  \draw[bus line] (16.0952,-13.9048) -- (16.3810,-13.9048) -- (16.3810,-12.7619) -- (16.7619,-12.7619) -- (18.0000,-12.7619);
  \draw[node line] (14.2857,-14.2857) -- (14.8571,-14.2857) -- (15.1429,-14.2857);
  \draw[bus line, ->] (13.7143,-12.7619) -- (14.0952,-12.7619) -- (14.0952,-13.9048) -- (14.8571,-13.9048) -- (15.1429,-13.9048);
  \draw[node line] (14.2857,-11.4286) -- (14.8571,-11.4286) -- (15.1429,-11.4286);
  \draw[node line, ->] (13.7143,-12.3810) -- (14.0952,-12.3810) -- (14.0952,-11.0476) -- (14.8571,-11.0476) -- (15.1429,-11.0476);
  \draw[node line] (16.0952,-11.0476) -- (16.3810,-11.0476) -- (16.3810,-12.3810) -- (16.7619,-12.3810) -- (18.0000,-12.3810);
  ...
  \draw[node line, ->] (15.6190,-13.3333) -- (15.6190,-13.4286);
  \draw[node line, ->] (15.6190,-10.4762) -- (15.6190,-10.5714);
  ...
  \draw[node line] (18.0000,-11.2381) -- (16.7619,-11.2381);
  \draw[node line] (18.0000,-10.0952) -- (16.7619,-10.0952);
  \draw[bus line] (18.0000,-11.6190) -- (16.7619,-11.6190);
  \draw[bus line] (18.0000,-10.4762) -- (16.7619,-10.4762);
  \draw[node line] (16.4762,-2.6667) -- (15.2381,-2.6667);
  \draw[node line, ->] (5.5357,-5.1429) -- (6.6667,-5.1429);
  \draw[node line, ->] (5.5357,-4.5714) -- (6.6667,-4.5714);
  ...
  \draw[line name] (14.4762,-11.3333) node[anchor=south west] {$\nodenamebit{clk}$};
  \draw[line name] (14.4762,-14.1905) node[anchor=south west] {$\nodenamebit{clk}$};
  \draw[line name] (15.5238,-15.8571) node[anchor=south west, rotate=90] {$\nodenamebit{nrst}$};
  \draw[line name] (15.5238,-12.9286) node[anchor=south west, rotate=90] {$\nodenamebit{nrst}$};
