...
Els
tres displays del resultat ($HEX2$, $HEX1$ i $HEX0$) s'assignen a la
conversió de $sigSel$, la xifra de més pes de $res$ i la de menys pes
respectivament. En cas que la xifra de més pes fos zero, l'assignament
canvia: \mintinline{vhdl}|"1111111"| al primer (display apagat), la
conversió del signe i la xifra de menys pes.
'''
